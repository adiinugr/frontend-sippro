...
// Type Imports
import type { InputReportFirstSemesterType } from '@/types/inputReportTypes'

// Style Imports
import styles from '@core/styles/table.module.css'

// Data Imports
import { firstSemesterInputData } from '@/data/dummy/reportInputData'

// Column Definitions
const columnHelper = createColumnHelper<InputReportFirstSemesterType>()
...
const defaultColumn: Partial<ColumnDef<InputReportFirstSemesterType>> = {
  cell: ({ getValue, row, column, table }) => {
    return <EditableCell getValue={getValue} row={row} column={column} table={table} />
  }
}

const ReportInputFirstSemester = () => {
  // States
  const [data, setData] = useState(() => firstSemesterInputData)
...
export default ReportInputFirstSemester
