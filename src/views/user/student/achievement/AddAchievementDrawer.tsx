...
type Props = {
  ...
  isLoading: boolean
  handleClose: () => void
  handleCreate: (data: AddAchievementType) => void
}

type FormValidateType = AddAchievementType

const AddAchievementDrawer = (props: Props) => {
  // Props
  ...
  const onSubmit = (data: AddAchievementType) => {
    handleCreate(data)
    handleClose()
    resetForm({ title: '', category: '', medal: '', level: '', organizer: '', date: null })
  }
  ...
  return (
    ...
    >
      <div className='flex items-center justify-between plb-5 pli-6'>
        <Typography variant='h5'>Tambah Prestasi Baru</Typography>
...
export default AddAchievementDrawer
