...
const UserStudentAdd = () => {
  ...
  const onSubmit = async (data: FormValues) => {
    const { email, password, name, nis, nisn, placeOfBirth, dateOfBirth } = data
  ...
  return (
    <Card>
      <CardHeader title='Input Data Siswa' />
      <Divider />
      <CardContent>
