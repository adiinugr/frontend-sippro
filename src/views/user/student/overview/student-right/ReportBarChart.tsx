...
const tabData: TabType[] = [
  {
    type: 'smt-1',
    avatarIcon: 'tabler-number-1',
    series: [{ data: [88, 90, 86, 78, 95, 80, 95, 88, 88, 90] }]
  },
  {
    type: 'smt-2',
    avatarIcon: 'tabler-number-2',
    series: [{ data: [85, 95, 85, 80, 82, 95, 88, 80, 80, 87] }]
  },
  {
    type: 'smt-3',
    avatarIcon: 'tabler-number-3',
    series: [{ data: [90, 82, 87, 83, 92, 79, 97, 82, 80, 80] }]
  },
  {
    type: 'smt-4',
    avatarIcon: 'tabler-number-4',
    series: [{ data: [87, 89, 92, 88, 90, 89, 90, 89, 89, 91] }]
  },
  {
    type: 'smt-5',
    avatarIcon: 'tabler-number-5',
    series: [{ data: [87, 89, 92, 88, 90, 89, 90, 89, 89, 91] }]
  },
  {
    type: 'smt-6',
    avatarIcon: 'tabler-number-6',
    series: [{ data: [] }]
  }
]
...
const ReportBarChart = () => {
  ...
  const options: ApexOptions = {
    ...
    xaxis: {
      ...
      categories: ['PAI', 'PP', 'BIN', 'MAT', 'IPA', 'IPS', 'BING', 'PJOK', 'IFM', 'SEN'],
      labels: {
        style: {
          colors: disabledText,
