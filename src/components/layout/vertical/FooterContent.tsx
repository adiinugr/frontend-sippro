...
const FooterContent = () => {
  ...
  return (
    ...
    >
      <p>
        <span className='text-textSecondary'>{`© ${new Date().getFullYear()}, Made with love`}</span>
        <span className='text-textSecondary'>{` by `}</span>
        <Link href='https://nehan.vercel.app/' target='_blank' className='text-primary uppercase'>
          Nehan Dev
        </Link>
      </p>
      {/* {!isBreakpointReached && (
